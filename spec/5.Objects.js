describe("Objects", () => {
	...
	describe("JSON", () => {
		...
		it("{hello: \"world\"} is an object with one field", () => {
			expect(Object("world")).toEqual(jasmine.any(Object));
		});
	...
	describe("get set", () => {
		...
		it("you can add dynamically any property", () => {
			object.foo = "ana";
			object["bar"] = "bu";
			expect({hello:"world", all:42, foo:"ana", bar:"bu"}).toEqual(object);
		});
